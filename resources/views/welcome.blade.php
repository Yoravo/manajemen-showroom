...
<html lang="en">
	<head><base href=""/>
		...
		<link rel="shortcut icon" href="{{ asset('assets/media/logos/arr-motor1.png') }}" />
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="d-flex align-items-center flex-equal">
									...
									<a href="{{ route('welcome') }}">
										<img alt="Logo" src="assets/media/logos/arr-motor1.png" class="logo-default h-50px h-lg-70px" />
								        ...
								        <nav class="-mx-3 flex flex-1 justify-end">
								            @auth
								                @if (Auth::user()->usertype === 'admin')
								                    <a href="{{ url('/admin/dashboard') }}" class="btn btn-success">
								                        Admin Dashboard
								                    </a>
								                @else
				...
				<div class="pb-15 pt-18 landing-dark-bg">
					...
					<div class="container">
						...
						<div class="fs-2 fw-semibold text-muted text-center">
							<a href="../../demo8/dist/account/security.html" class="link-primary fs-4 fw-bold">Marcus Levy,</a>
						...
						<div class="row py-10 py-lg-20">
							...
							<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
								...
								<div class="rounded landing-dark-border p-9">
									...
									<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-white opacity-50 text-hover-primary">Click to Get a Quote</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
							</div>
