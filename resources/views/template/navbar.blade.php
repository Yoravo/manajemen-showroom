<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <a href=" {{ route('welcome') }} ">
            <img alt="Logo" src="{{ asset('assets/media/logos/arr-motor1.png') }}" class="h-50px h-lg-70px" />
        </a>
        <!--end::Logo-->
...
<div class="page-title d-flex justify-content-center flex-column me-5">
    <!--begin::Title-->
    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">@yield('page-title', 'Dashboard')</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-active">@yield('page-title', 'Dashboard')</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
</div>
